...
public class AdminServiceImpl implements AdminService{
    ...
    public Map<String, Object> getTeacher(Integer collegeId){
        ...
        for(Useridentity useridentity:useridentities){
            teacherMap = new HashMap<>(ConstantUtil.MIN_HASH_MAP_NUM);
            teacherMap.put("teacherID",useridentity.getJobNum());
    ...
    @Override
    public Map<String, Object> delSchool(Integer schoolId) {
    ...
    @Override
    public Map<String, Object> delCollege(Integer collegeId) {
    ...
    @Override
    public Map<String, Object> delStudent(Integer schoolId, Integer studentNum) {
    ...
    @Override
    public Map<String, Object> delTeacher(Integer schoolId, Integer jobNum) {
